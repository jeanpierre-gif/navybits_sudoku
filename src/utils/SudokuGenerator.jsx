...
export const generateSudokuPuzzle = (difficulty = 'medium') => {
  ...
  // Define the number of cells to remove based on difficulty level
  let emptyCells;
  switch (difficulty) {
      case 'easy':
          emptyCells = 30; // Easier puzzle with fewer empty cells
          break;
      case 'medium':
          emptyCells = 40; // Medium difficulty
          break;
      case 'hard':
          emptyCells = 50; // Harder puzzle with more empty cells
          break;
      default:
          emptyCells = 40; // Default to medium if invalid input
  }
